...
export const BUTTON_CLASSES =
    "w-full bg-gradient-to-r from-sky-300 to-blue-800 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"

// PROFILE CSS
export const INPUT_WRAPPER =
    "flex items-center border border-blue-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all duration-200"
export const FULL_BUTTON =
    "w-full bg-gradient-to-br from-sky-300 to-blue-800 text-white py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const PRODUCTIVITY_CARD = {
    ...
    barFg: "h-full bg-gradient-to-r from-sky-300 to-blue-800 animate-pulse",
}
...
export const BUTTONCLASSES =
    "w-full bg-gradient-to-br from-sky-300 via-blue-500 to-blue-800 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const getPriorityColor = (priority) => {
    const colors = {
        ...
        medium: "border-sky-500 bg-sky-50/50 text-blue-600",
...
export const ADD_BUTTON =
    "flex items-center gap-2 bg-gradient-to-r from-sky-300 to-blue-800 text-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base"
...
export const EMPTY_STATE = {
    ...
    btn: "px-4 py-2 bg-gradient-to-r from-sky-300 to-blue-800 text-white rounded-lg text-sm font-medium",
}
...
export const TI_CLASSES = {
    ...
    progressBarFg: "h-full bg-gradient-to-r from-sky-300 to-blue-800 transition-all duration-300",
