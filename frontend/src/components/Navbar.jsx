        ...
        <header className = "sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
            <div className = "flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
                ...
                <div className = "flex items-center gap-2 cursor-pointer group"
                    onClick={() => navigate('/')}>
                        {/*LOGO */}
                        <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-sky-300 via-blue-500 to-blue-800 
                        ...
                        {/* BRAND NAME */}
                        <span className=" text-2xl font-extrabold bg-gradient-to-br from-sky-300 via-blue-500 to-blue-800 bg-clip-text text-transparent tracking-wide">TurboTask</span>
                </div>
                ...
                <div className=" flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        py-2 rounded-full cursor-pointer hover:bg-blue-50 transition-colors duration-300 border
                        border-transparent hover:border-blue-200">
                            <div className="relative">
                                {user.avatar ? (
                                    ...
                                    <div className=" w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-sky-300 via-blue-500 to-blue-800 text-white font-semibold
                                    shadow-md">
                        ...
                        {menuOpen && (
                            ...
                            shadow-xl border border-blue-100 z-50 overflow-hidden animate-fadeIn">
                                <li className=" p-2">
                                    <button onClick={() => {
                                        setMenuOpen(false)
                                        navigate('/profile')
                                    }}
                                        className=" w-full px-4 py-2.5 text-left hover:bg-blue-50 text-sm
