...
const Layout = ({ onLogout, user}) => {
    ...
    if(loading) return (
        <div className=" min-h-screen bg-gray-50 flex items-center justify-center">
            <div className=" animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-300"/>
        </div>
    )
    ...
    if(error) return (
        <div className=" min-h-screen bg-gray-50 p-6 flex items-center justify-center">
            <div className=" bg-red-50 text-red-600 p-4 rounded-xl border-red-100 max-w-md">
                ...
                <button onClick={fetchTasks} className=" mt-4 py-2 px-5 bg-red-100 text-red-700 rounded-lg
    ...
    return (
        <div className=" min-h-screen bg-gray-50">
            ...
            <div className="ml-o xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300">
