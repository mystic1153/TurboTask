...
const SignUp = ({onSwitchMode}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            console.log("Signupp Successfull", data)
    ...
    return (
        <div className=" max-w-md w-full bg-white shadow-lg border border-blue-100 rounded-xl p-8">
            <div className=" mb-6 text-center">
                <div className=" w-16 h-16 bg-gradient-to-br from-sky-300 to-blue-800 rounded-full
                ...
                <p className=" text-gray-500 text-sm mt-1">Join TurboTask to manage your tasks</p>
            </div>
            ...
            <p className=" text-center text-sm text-gray-600 mt-6">
                ...
                <button onClick={onSwitchMode} className=" text-blue-600 hover:text-blue-700 hover:underline
